                ...
                <div class="col-lg-12">
                    <div class="card">                                            
                                ...
                                <div class="col-lg-12" id="admin-area">
                                    <form action="{{url('/admin/tambah_teknis')}}" method="post" enctype="multipart/form-data">
                                        {{csrf_field()}}
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="tipe_file" class="form-control">                                                        
                                                        <option value="1">Setelah Bayar</option>
                                                        <option value="2">Sebelum Bayar</option>
                                                    </select>
                                                </div>                                
                                            </div>
                                                    ...
                                                    @foreach($getTeknis as $dats)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <a href="{{url('/admin/hapus_teknis/'.$dats->id)}}" class="btn btn-danger"><span class="fa fa-trash"></span> </a>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    @endforeach
