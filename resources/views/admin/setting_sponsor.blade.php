                ...
                <div class="col-lg-12">
                    <div class="card">                                            
                                ...
                                <div class="col-lg-12" id="admin-area">
                                    <form action="{{url('/admin/tambah_sponsor')}}" method="post" enctype="multipart/form-data">
                                        {{csrf_field()}}
                                        <div class="col-lg-12 row">
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <label for="">Nama Sponsor / Meida Partner</label>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="file" class="form-control" name="image_sponsor" required>
                                                </div>                                
                                            </div>
                                            ...
                                            <table class="table table-bordered" id="tabel-sponsor">
                                                <thead>
                                                    <tr>
                                                        <th>No</th>
                                                        <th>Gambar</th>
                                                        <th>Nama Sponsor / Media partner</th>												
                                                        <th>Tipe</th>  
                                                        <th>Action</th>                                                      
                                                    </tr>
                                                </thead>
                                                ...
                                                @php
                                                    $no = 1;
                                                @endphp
                                                @foreach($getSponsor as $dats)
                                                    <tr>
                                                        <td>{{$no++}}</td>
                                                        <td><img src="{{'http://wseum.com/2019/Sponsor/'.$dats->image}}" width="100px" alt=""></td>
                                                        <td>{{$dats->keterangan}}</td>
                                                        <td>
                                                            @if($dats->tipe == 1)
                                                                Sponsor
                                                            @else
                                                        ...
                                                        <td>
                                                            <a href="{{url('admin/hapus_sponsor/'.$dats->id)}}" class="btn btn-danger">
