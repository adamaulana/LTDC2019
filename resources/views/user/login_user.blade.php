...
<html lang="en">
    ...
    <title>LTDC 2019 - Login Peserta</title>
    @if(Session::has('id_tim'))
        <script>
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-xs-12">
                    <div class="flat-card">
                        ...
                        <br><br>
                        <form action="{{url('/peserta/login')}}" method="post">
                             <b> LTDC 2019 - Login Peserta </b> <br> <br>
                            <small class="text-muted">Silahkan masukkkan email ketua dan password <br> yang di inputukan ada saat registrasi</small>
                            </h5>                            
                            ...
                            @endif
                            {{csrf_field()}}                            
                            <input type="email" name="email" class="form-control" placeholder="Email Ketua">
